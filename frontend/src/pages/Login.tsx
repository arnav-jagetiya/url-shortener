...
export const Login: React.FC = () => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-950 px-4 py-12 relative overflow-hidden">
      ...
      <div className="w-full max-w-md space-y-8 rounded-2xl border border-slate-900 bg-slate-900/40 p-8 backdrop-blur-xl shadow-2xl relative min-h-[440px] flex flex-col justify-center transition-all duration-300">
        {isSuccess ? (
          ...
          <div className="text-center space-y-4 animate-in fade-in zoom-in-95 duration-300">
            ...
            <h3 className="text-xl font-bold text-white">Successfully Authenticated</h3>
            <p className="text-xs text-slate-400">Loading your Shortify dashboard...</p>
          </div>
        ) : (
          <>
            {/* Brand/Logo */}
            <div className="text-center">
              ...
              <p className="mt-2 text-sm text-slate-400">
                Or{" "}
                <Link to="/register" className="font-semibold text-indigo-400 hover:text-indigo-350 transition-colors focus:outline-none focus:underline">

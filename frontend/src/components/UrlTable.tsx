    ...
    <div className="space-y-4">
      ...
      <div className="relative w-full max-w-sm">
        ...
        <input
          ...
          className="w-full rounded-xl border border-slate-800 bg-slate-950/40 py-2.5 pl-9 pr-4 text-xs text-white placeholder-slate-550 focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 transition-colors"
        />
      </div>
                    ...
                    <td className="p-4 text-right">
                      <div className="flex justify-end gap-2">
                        <button
                          ...
                          className="cursor-pointer rounded-lg bg-slate-900 border border-slate-800 p-2 text-slate-450 hover:text-white hover:border-slate-700 transition-all"
                          title="Copy Link"
                        >
                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4">
                        ...
                        <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          className="cursor-pointer rounded-lg bg-slate-900 border border-slate-800 p-2 text-slate-450 hover:text-white hover:border-slate-700 transition-all flex items-center justify-center"
                          title="Open Link"
                        >
                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4">
                        ...
                        <button
                          ...
                          className="cursor-pointer rounded-lg bg-slate-900 border border-slate-800 p-2 text-red-400 hover:bg-red-550/10 hover:border-red-500/30 transition-all animate-none"
                          title="Delete Link"
                        >
                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4">
              ...
              <div key={url.id} className="rounded-2xl border border-slate-900 bg-slate-950/65 p-5 space-y-4 shadow-sm">
                ...
                <div className="space-y-3 text-xs">
                  ...
                  <div>
                    ...
                    <span className="text-slate-300 break-all block leading-relaxed" title={url.originalUrl}>
                      {url.originalUrl}
                    </span>
                  </div>
                  <div className="grid grid-cols-3 gap-2 border-t border-slate-900/60 pt-3">
                    ...
                    <div>
                      ...
                      <span className="text-slate-400 text-[10px]">{formatDisplayDate(url.createdAt)}</span>
                    </div>
                    <div>
                      <span className="block text-[9px] font-semibold text-slate-500 uppercase tracking-wider mb-0.5">
                        Expires
                ...
                <div className="flex gap-2 border-t border-slate-900/60 pt-3">
                  <button
                    onClick={() => handleCopy(url.shortUrl)}
                    className="cursor-pointer flex-grow flex items-center justify-center gap-1.5 rounded-xl border border-slate-800 bg-slate-900/50 py-2.5 text-xs text-slate-300 hover:text-white"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 17.25v3.375c0 .621-.504 1.125-1.125 1.125h-9.75a1.125 1.125 0 0 1-1.125-1.125V7.875c0-.621.504-1.125 1.125-1.125H5.25m11.9-3.664A2.251 2.251 0 0 0 15 2.25h-1.5a2.251 2.251 0 0 0-2.15 1.586m5.8 0c.065.21.1.433.1.664v.75h-6V4.5c0-.231.035-.454.1-.664M6.75 7.5H4.875c-.621 0-1.125.504-1.125 1.125v12c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V16.5a9 9 0 0 0-9-9Z" />
                    </svg>
                  ...
                  <button
                    onClick={() => onDeleteRequest(url)}
                    className="cursor-pointer flex-grow flex items-center justify-center gap-1.5 rounded-xl border border-red-500/20 bg-slate-900/50 py-2.5 text-xs text-red-400 hover:bg-red-550/10 hover:border-red-500/30"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4">
                      <path strokeLinecap="round" strokeLinejoin="round" d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 0 1 3.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 0 0-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 0 0-7.5 0" />
                    </svg>
